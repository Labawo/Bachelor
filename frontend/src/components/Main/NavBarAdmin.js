      ...
      <div className="navbar">
        ...
        <div className={`nav-links ${showSidebar ? 'showSidebar' : ''}`}>
          ...
          <ul className="links">
            ...
            <li><Link to="/admin" className={!canAccessAdmin ? 'hidden' : ''}>NAUDOTOJAI</Link></li>
            <li>
              <a onClick={toggleHtmlCssSubMenu} className={!canAccessAdmin ? 'hidden' : ''}>LYGIAI</a>
            ...
            <li><Link to="/badgesPage" className={canAccessAdmin ? '' : 'hidden'}>ŽENKLELIAI</Link></li>
            <li><Link to="/notes" className={canAccessAdmin ? '' : 'hidden'}>UŽRAŠAI</Link></li>
            <li>
